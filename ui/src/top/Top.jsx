...
const useStyles = makeStyles((theme) => ({
  ...
  rankField: {
    fontWeight: 700,
    color: theme.palette.type === 'dark' ? '#667eea' : '#764ba2',
    minWidth: '40px',
  },
}))
...
const TopListContent = () => {
  ...
  }, [isDesktop, classes.ratingField, classes.rankField])
    ...
    <>
      <Box className={classes.header}>
        <Typography className={classes.headerTitle}>
          🏆 {translate('menu.top.title')}
        </Typography>
        <Typography className={classes.headerSubtitle}>
          {translate('menu.top.subtitle')}
        </Typography>
      </Box>
...
const Top = (props) => {
  ...
  return (
    <>
      <PageTitle title={<Title subTitle={translate('menu.top.name')} />} />
